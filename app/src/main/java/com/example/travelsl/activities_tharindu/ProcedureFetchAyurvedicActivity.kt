...
class ProcedureFetchAyurvedicActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.procedure_activity_fetch_ayurvedic)
        ...
        query.addValueEventListener(object: ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()){
                    ...
                    val intent = Intent(this@ProcedureFetchAyurvedicActivity, ProcedureInsertActivity::class.java);
                    startActivity(intent);
                }
            }
